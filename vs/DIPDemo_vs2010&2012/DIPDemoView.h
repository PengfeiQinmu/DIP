...
public:
	...
	afx_msg void OnMenuDct();
	afx_msg void OnDct1();
	afx_msg void OnDct2();
	afx_msg void OnMuneArith();
	afx_msg void OnMenuAdaMed();
	afx_msg void OnAddGaussian();
	afx_msg void OnAddSalt();
	afx_msg void OnAddRayleigh();
	afx_msg void OnAddUniform();
	afx_msg void OnInverseFTuihua();
	afx_msg void OnInvRestore();
	afx_msg void OnNoiseTuihua();
